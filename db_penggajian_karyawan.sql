...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2022 at 04:04 PM
...
INSERT INTO `pegawai` (`id`, `nama`, `tgl_lahir`, `alamat`, `id_divisi`, `id_jabatan`, `no_rekening`) VALUES
(1, 'Pegawai Lengkap', '2022-05-11', 'Alamat Pegawai', '1', '2', '1234567890'),
(2, 'Customer', '2022-05-10', 'Customer', '2', '1', '0987654321'),
(4, 'admin', '2002-09-20', 'admin', '1', '1', '0987654321122');
...
CREATE TABLE `shift` (
  ...
  `jam_masuk` varchar(250) DEFAULT NULL,
  `jam_pulang` varchar(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(2, 'admin', 'admin', 'admin@gmail.com', NULL, 'super admin', NULL, NULL, '$2y$10$z/RDzlDkqyGPCiNgdOYO3.dqYGcOQHs07AX6pVIyGDhZqbzL14ZBO', 'YDuMvHDkGbAXcEPAi7aVazwvA0PdBJs9fElQeWvAs1uKVch13qHMM5iNhO6J', '2022-05-12 22:38:32', '2022-05-12 22:38:32');
