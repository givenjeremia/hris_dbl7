            ...
            <div class="col-12">
                ...
                <div class="card card-warning">
                    ...
                    <form method="POST" onsubmit="return validasiinput();" role="form" enctype="multipart/form-data"
                        action="{{url('/backend/shift/'.$row->id)}}">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" name="jam_masuk" value="{{$row->jam_masuk}}"
                                            required>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Jam Pulang</label>
                                        <input type="time" class="form-control" name="jam_pulang" value="{{$row->jam_pulang}}"
                                            required>
                                    </div>
                                </div>
                            </div>
